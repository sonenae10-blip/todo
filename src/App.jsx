...
const InlineDateInput = styled(DateInput)`
    padding: 8px 10px;
    font-size: 13px;
`;
...
function App() {
    ...
    const handleEditStart = (item, index) => {
    ...
    const handleEditSave = () => {
        ...
        setTodoList(
            todoList.map((item, idx) =>
                idx === editingIndex
                    ? { ...item, text: trimmed, date: editDate }
                    : item
            )
        );
        setEditingIndex(null);
                        ...
                        <List>
                            {visibleList.map(({ item, index }) => (
                                <TodoItem
                                    ...
                                    onEditStart={() => handleEditStart(item, index)}
